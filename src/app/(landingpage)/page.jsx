...
import Transfert from "/public/images/transfer.svg"
...
export default function Home() {
  return (
    ...
    <div className={styles.btnplan}>
       <div></div>
      <button className={styles.button}>Chose Plan</button>
      <div></div>
    </div>
    {/* <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div class="mr-auto place-self-center lg:col-span-7">
            <h1 class="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-[#0f94c4]">Payments tool for software companies</h1>
